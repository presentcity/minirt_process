...
double 		make_plane(t_plane *plane, t_camera *cam) // https://www.scratchapixel.com/lessons/3d-basic-rendering/minimal-ray-tracer-rendering-simple-shapes/ray-plane-and-ray-disk-intersection
{
	double denom;
	double t;
	t_vec3f dif;
